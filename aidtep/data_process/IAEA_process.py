...
class IAEADataProcessBuilder:
    ...
    def load_raw_data(self, data_path: str, data_type: str):
        """
        ...
        self.data = data.reshape(constants.IAEA_DATA_SIZE, *constants.IAEA_DATA_SHAPE)
        logger.debug(f"IAEA raw data shape: {self.data.shape}")
        return self
