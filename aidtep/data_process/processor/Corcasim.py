...
class CorcasimDataProcessor(DataProcessor):
    ...
    def load_raw_data(self, data_path_10000: str, data_path_8480: str):
        ...
        data_10000 = np.loadtxt(data_path_10000).reshape(
            -1, *constants.CORCASIM_DATA_SHAPE
        )
        data_8480 = np.loadtxt(data_path_8480).reshape(
            -1, *constants.CORCASIM_DATA_SHAPE
        )
